...
users = session.query(User).filter_by(id = 29).all() # you can also use one_or_none() method to access the single # user if you know that there is only single user in the database(Table)
